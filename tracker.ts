...
interface Tracker {
  ...
  inFlush(): boolean;
  autorun(f: UNKNOWN_FUNC, options: AutorunOpts): void;
 ...
 */
Tracker.flush = function (options: FlushOptions) {
  Tracker._runFlush({
...
Tracker._runFlush = function (options?: Partial<FlushOptions>) {
 ...
 */
Tracker.autorun = function (f: UNKNOWN_FUNC, options: AutorunOpts) {
  options = options;
